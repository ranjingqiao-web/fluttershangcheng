...
//         title: Text('这是搜索页面'),
//         ),
//         body: Text("这是搜索页面${arguments != null? arguments['id']:'9999'}"),
//      );
//    }
//  }
...
class BrandHallPage extends StatefulWidget {
  @override
  _BrandHallPageState createState() => _BrandHallPageState();
}

class _BrandHallPageState extends State<BrandHallPage> {
